...
if(isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    if(empty($date_err) && empty($time_err) && empty($sport_err) && empty($team_1_err) && empty($team_2_err) ) {
        ...
        $sql = "UPDATE events SET date=:date, time=:time, sport_id=:sport_id, team_1=:team_1, team_2=:team_2 WHERE id=:id";
        ...
        <div class="container mt-md">
            <div class="row">
                <div class="offset-2 col-8 offset-2">
                    <h1 class="heading-1 text-center mt-lg mb-sm">Update event</h1>
                    <p class="mb-sm">Please edit the input values and submit to update the record.</p>
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($time_1_err)) ? 'has-error' : ''; ?>">
                            <label>Team 1</label>
                            <textarea name="team_1" class="form-control"><?php echo $team_1; ?></textarea>
